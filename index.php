...
<div class="modal-content">
  ...
  <div class="modal-content">
    <span class="close">&times;</span>
    <div class=" card col-lg text-center  shadow card-body">
            <?php
                        ?>
                <?php 
                    if (isset($_POST['sub'])) {
                        ...
                        if (empty($req)) {
                            echo "";
                            ?>
                            <script type='text/javascript'>alert('Field cannot be empty');</script>
                            <?php
                        }else{
                        
                            $query = "INSERT INTO requests(rNo, request) VALUES('{$reg}', '{$req}') ";
                            $res = mysqli_query($conn, $query);
                            if (!$res) {
                                die("QUERY FAILED" . mysqli_error($conn));       
                        }else{
                            ?>
                            <script type='text/javascript'>alert('Request Sent');</script>
                            <?php
                        }
                    }
                    }
                ...
                <h3 class="">Request For Clearance if pending</h3>
                <div class="row">

                </div>
                <div class="form-group col-lg-6">
                    <label for="reg">Registration Number</label>
                <input type="text" class="form-control" name="reg"  value="<?php echo $rowaccess['matric_no'];  ?>">
                                </div>
                <div class="form-group col-lg-6">
                    <label for="req">Reason For Requesting</label>
                <input type="text" class="form-control" name="requ" placeholder="eg- i make all payments">
                                </div>
                                <div class="form-group">
                <button name="sub" type="submit" class="btn btn-success">Request</button>
                </div>
                </form>
                    </div>   
...
<?php echo "Pending  <button id='myBtn' class='btn btn-success'>Request For Clearance</button>"; ?></div>
	  <?php } ?> </h3>
                ...
                <td width="1237"><table border="0" align="center" class="table table-hover no-margins">
                  <thead>
                    <tr>
					  ...
					  <th width="30%"><div align="center"><span class="style1">MSSN</span></div></th>
